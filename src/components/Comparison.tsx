      ...
      <div className="max-w-7xl px-5 py-32 mx-auto">
        ...
        <div className="overflow-x-auto bg-white/5 rounded-3xl backdrop-blur-sm md:p-10 p-5 py-10">
          <table className="table-auto w-full border-collapse">
            <thead>
              <tr>
                <th className="px-4 pb-10 border-b border-r font-secondaryRegular tracking-widest text-primary text-2xl border-gray-700">
                  <div className="logo flex justify-center items-center">
                    Comparison
                  </div>
                </th>
                <th className="px-4 pb-10 border-b border-r border-gray-700">
                  <div className="logo flex justify-center items-center">
                    <img src="/assets/logo-2.png" alt="Logo" className="w-42" />
                  </div>
                </th>
                <th className="px-4 pb-10 border-b border-gray-700">
                  <div className="logo flex justify-center items-center">
            ...
            <tbody>
              {Array.from({ length: 5 }).map((_, index) => (
                <tr key={index} className="text-gray-400 text-xl">
                  <td className="px-4 border-b border-r border-gray-700 py-5">
                    {index + 1}. Point no two this
                  </td>
                  <td className="px-4 border-b border-r border-gray-700 py-5 text-green-500">
                    ✔️
                  </td>
                  <td className="px-4 border-b  border-gray-700 py-5 text-red-500">
                    ❌
                  </td>
                </tr>
              ))}
